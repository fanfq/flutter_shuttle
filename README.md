...
- Background command execution
  ...
  - Each background task has a live log view for stdout/stderr output.
  - Log views keep the most recent output for the current Shuttle session.
...
- Terminal execution mode
  ...
  - Terminal-run command output stays in Terminal instead of the Shuttle log view.
